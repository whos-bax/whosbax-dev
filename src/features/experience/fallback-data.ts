    ...
    list: [
      {
        ...
        description:
          'AI 정비소 관리 시스템 웹/앱 서비스의 기능 개발, UI/UX 개선 및 운영',
        summaryList: [
          'LLM 활용 홍보 기능 개발',
          '- GPT, Claude API를 활용해 정비소별 맞춤형 블로그 콘텐츠 자동 생성 시스템 설계 및 개발',
          '- 기능 출시 후 1개월 내 첫 매출 발생, 월간 콘텐츠 생성량 100건 이상으로 확장 가능성 확인',
          'HOS v2 앱 전면 재구축',
          '- 정비 등록/상세/결제/미디어 업로드 등 핵심 기능 설계 및 구현',
          '- Typography/Button 디자인 시스템 구축으로 UI 일관성 확보',
          '- 카메라 촬영/분석 플로우 개발 및 정비 항목 UX 최적화',
          '앱 UI/UX/성능 개선',
          '- React Native 코드베이스 전면 리팩토링을 통해 렌더링 속도 30% 개선',
          '- 중복 컴포넌트 제거 및 공통 모듈화로 재사용률 향상, 유지보수 비용 감소',
          '- Foreground Service 기반 전화 수신 팝업 기능 개선 (Android)',
        ],
      },
      {
        title: `HAIST (앱/웹)`,
        ...
        description:
          '미국 시장 타겟 AI 기반 정비 보조 글로벌 앱/웹 서비스 신규 개발 및 출시',
        summaryList: [
          '앱 신규 개발 및 출시',
          '- React Native 기반 앱 설계부터 스토어 출시까지 전 과정 주도',
          '- Firebase Crashlytics/Analytics 연동으로 안정성 모니터링 체계 구축',
          '- JWT 기반 인증 및 토큰 갱신 로직 구현',
          '핵심 기능 구현',
          '- 비디오 촬영과 음성 인식의 독립적 실행 구조 설계',
          '- 리포트 태그 기반 정비 분석 기능 개발',
          '웹 랜딩 페이지 개발',
          '- Next.js 기반 서비스 소개 및 프라이싱 페이지 개발',
        ],
      },
      {
        title: `HOSChat (앱)`,
        ...
        description:
          'LLM 기반 차량 진단 챗봇 앱 신규 개발 및 출시 (Phase 1~4)',
        summaryList: [
          'Phase 1~4 전 과정 설계 및 구현',
          '- Phase 1: 이미지 분석 서비스 레이어 구현',
          '- Phase 2: 이미지 분석 + VIN 조회 서비스 연동',
          '- Phase 3: LLM 연동 및 UI 개선',
          '- Phase 4: 리포트 기능, 알림톡 전송, 정비소 연동',
          '백엔드 API 개발',
          '- 알림톡 전송 API 엔드포인트 설계 및 구현',
        ],
      },
    ],
  },
    ...
    list: [
      {
        ...
        summaryList: [
          ...
          '정부 사업 과제 참여',
          '- Unreal Engine 5를 활용하여 AI 라벨링용 합성 영상/이미지 직접 제작',
        ],
      },
    ],
  },
    ...
    list: [
      ...
      },
      {
        ...
        summaryList: [
          ...
          '- 물류/CS/상품등록/정산 등 복잡한 관리 기능 재설계로 운영 효율 향상',
        ],
      },
      {
        title: `당영투게더`,
        ...
        summaryList: [
          ...
          '코드 품질 보장',
          '- ESLint, Prettier, Husky, lint-staged 도입하여 코드 표준화 및 자동 검증 체계 구축',
          '도메인 관리 및 인프라 운영',
      ...
      },
      {
        ...
        description:
          'React Native 기반 사용자용·관리자용 모바일 앱 2종 개발 및 운영',
        summaryList: [
          '프로젝트 리딩 및 배포',
